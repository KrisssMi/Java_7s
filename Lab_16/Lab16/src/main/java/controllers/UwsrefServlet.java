...
public class UwsrefServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            StringBuilder jsonBody = new StringBuilder();   // StringBuilder - изменяемая строка
            BufferedReader reader = req.getReader();        // getReader - позволяет читать текстовые данные из запроса
            String line;
